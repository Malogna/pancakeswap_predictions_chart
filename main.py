...
PCS_BNB_ORACLE_CONTRACT = '0xD276fCF34D54A926773c399eBAa772C12ec394aC'
    ...
    def get_oracle_tick_data(n):
        ...
        while current_write_round != latest_round:
            ...
            if int(current_round_data[2]) != 0:
                ...
                print(f'Downloading last 200 tick datas for technical analysis generation: {abs(current_write_round - latest_round)}/{n}      ', end='\r')
